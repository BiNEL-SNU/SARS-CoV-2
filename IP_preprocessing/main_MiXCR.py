...
#           Including MiXCR processing step
...
from utils.PreprocessWorker_MiXCR import PreprocessWorker
...
def main():
    ...
    All functions needs following parameters:
        ...
        - step : 1, 2, 3, or 4 according to what you want to do
            1 = error correction using MiXCR processing
            2 = isotyping
            3 = annotation
    ...
    """
    # 1. Run error correction = primer recognition -> applying MiXCR
